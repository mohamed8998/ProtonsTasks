...
function Bananas() {
  ...
  return (
    <Container>
      <h1>Bananas</h1>  
      <p>Count: {count}</p>  {/* Display the current number of banana*/}
      <Button variant="warning" onClick={() => setCount(count + 1)}>Add</Button>  {/* Add a button to increase a number and variable allow you to define the styles can used colors*/}
