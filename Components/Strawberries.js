...
function Strawberries() {
  ...
  return (
    <Container>
      <h1>Strawberries</h1>
      <p>Count: {count}</p>  {/* Display the current number of strawberries*/}
      <Button variant="success" onClick={() => setCount(count + 1)}>Add</Button>  {/* Add a button to increase a number and variable allow you to define the styles can used colors */}
